...
const fuelType = asyncHandler(async (req, res, next) => {
    try {
        ...
        res.status(201).json({ message: "FuelType created successfully", data: newFuelType });
    } catch (error) {
...
// Export the functions for use in routes
    export { fuelType, getAllFuelTypes, getFuelTypeById, updatedFuelType };
